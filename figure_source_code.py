...
def umap_figure(adata):
    sp.pl.umap_scatter(adata, fontsize=8, ncol=3, savefig='results/pancreas/umap.pdf')
...
def Jacobian_figures(adata):
    ...
    '''
    sp.pl.visualize_jacobian(adata, savefig='results/pancreas/jacobians.pdf')
    sp.pl.eigen_spectrum(adata, savefig='results/pancreas/eigen_spectrum.pdf')
...
def state_GRN_figures(adata):
    ...
    sp.pl.visualize_network(adata, 'Ductal', weight_quantile=.95, plot_interactive=False,
                            savefig='results/pancreas/ductal_GRN_wq095.pdf', figsize=(5, 3.75))
    sp.pl.visualize_network(adata, 'Ngn3 low EP', weight_quantile=.95, plot_interactive=False,
                            savefig='results/pancreas/Ngn3_lowEP_GRN_wq095.pdf', figsize=(5, 3.75))
    sp.pl.visualize_network(adata, 'Ngn3 high EP', weight_quantile=.95, plot_interactive=False,
                            savefig='results/pancreas/Ngn3_highEP_GRN_wq095.pdf', figsize=(5, 3.75))
    sp.pl.visualize_network(adata, 'Pre-endocrine', weight_quantile=.95, plot_interactive=False,
                            savefig='results/pancreas/Pre_endocrine_GRN_wq095.pdf', figsize=(5, 3.75))
    sp.pl.visualize_network(adata, 'Alpha', weight_quantile=.95, plot_interactive=False,
                            savefig='results/pancreas/Alpha_GRN_wq095.pdf', figsize=(5, 3.75))
    sp.pl.visualize_network(adata, 'Beta', weight_quantile=.95, plot_interactive=False,
                            savefig='results/pancreas/Beta_GRN_wq095.pdf', figsize=(5, 3.75))
    sp.pl.visualize_network(adata, 'Delta', weight_quantile=.95, plot_interactive=False,
                            savefig='results/pancreas/Delta_GRN_wq095.pdf', figsize=(5, 3.75))
    sp.pl.visualize_network(adata, 'Epsilon', weight_quantile=.95, plot_interactive=False,
                            savefig='results/pancreas/Epsilon_GRN_wq095.pdf', figsize=(5, 3.75))

    # plot the signaling hubs for each cell state
    sp.pl.plot_signaling_hubs(adata, 'Ductal', savefig='results/pancreas/Ductal_hubs.pdf')
    sp.pl.plot_signaling_hubs(adata, 'Ngn3 low EP', savefig='results/pancreas/Ngn3_lowEP_hubs.pdf')
    sp.pl.plot_signaling_hubs(adata, 'Ngn3 high EP', savefig='results/pancreas/Ngn3_highEP_hubs.pdf')
    sp.pl.plot_signaling_hubs(adata, 'Pre-endocrine', savefig='results/pancreas/Pre_endocrine_hubs.pdf')
    sp.pl.plot_signaling_hubs(adata, 'Alpha', savefig='results/pancreas/Alpha_hubs.pdf')
    sp.pl.plot_signaling_hubs(adata, 'Beta', savefig='results/pancreas/Beta_hubs.pdf')
    sp.pl.plot_signaling_hubs(adata, 'Delta', savefig='results/pancreas/Delta_hubs.pdf')
    sp.pl.plot_signaling_hubs(adata, 'Epsilon', savefig='results/pancreas/Epsilon_hubs.pdf')

    # plots about the gene role variation across cell states
    sp.pl.gene_variation(adata, method='inter_range', savefig='results/pancreas/node_variability.pdf',
                         figsize=(7, 3))
    sp.pl.gene_var_detail(adata, savefig='results/pancreas/gene_var_detail.pdf')
    sp.pl.gene_var_scatter(adata, savefig='results/pancreas/gene_var_scatter.pdf')
...
def transition_figures(adata):
    ...
    sp.pl.plot_signaling_change(adata, 'Ductal', 'Ngn3 low EP',
                                savefig='results/pancreas/Ductal_to_lowEP_sign_change.pdf')
    sp.pl.plot_signaling_change(adata, 'Ngn3 low EP', 'Ngn3 high EP',
                                savefig='results/pancreas/lowEP_to_highEP_sign_change.pdf')
    sp.pl.plot_signaling_change(adata, 'Ngn3 high EP', 'Pre-endocrine',
                                savefig='results/pancreas/highEP_to_Pre_sign_change.pdf')
    sp.pl.plot_signaling_change(adata, 'Pre-endocrine', 'Alpha',
                                savefig='results/pancreas/Pre_to_Alpha_sign_change.pdf')
    sp.pl.plot_signaling_change(adata, 'Pre-endocrine', 'Delta',
                                savefig='results/pancreas/Pre_to_Delta_sign_change.pdf')
    sp.pl.plot_signaling_change(adata, 'Pre-endocrine', 'Beta',
                                savefig='results/pancreas/Pre_to_Beta_sign_change.pdf')
    sp.pl.plot_signaling_change(adata, 'Pre-endocrine', 'Epsilon',
                                savefig='results/pancreas/Pre_to_Epsilon_sign_change.pdf')

    # core GRN of DEG and transition genes
    sp.pl.core_GRN(adata, 'Ductal', 'Ngn3 low EP',
                                savefig='results/pancreas/Ductal_to_lowEP_GRN.pdf', figsize=(4, 4))
    sp.pl.core_GRN(adata, 'Ngn3 low EP', 'Ngn3 high EP',
                                savefig='results/pancreas/lowEP_to_highEP_GRN.pdf', figsize=(4, 4))
    sp.pl.core_GRN(adata, 'Ngn3 high EP', 'Pre-endocrine',
                                savefig='results/pancreas/highEP_to_Pre_GRN.pdf', figsize=(4, 4))
    sp.pl.core_GRN(adata, 'Pre-endocrine', 'Alpha',
                                savefig='results/pancreas/Pre_to_Alpha_GRN.pdf', figsize=(4, 4))
    sp.pl.core_GRN(adata, 'Pre-endocrine', 'Delta',
                                savefig='results/pancreas/Pre_to_Delta_GRN.pdf', figsize=(4, 4))
    sp.pl.core_GRN(adata, 'Pre-endocrine', 'Beta',
                                savefig='results/pancreas/Pre_to_Beta_GRN.pdf', figsize=(4, 4))
    sp.pl.core_GRN(adata, 'Pre-endocrine', 'Epsilon',
                                savefig='results/pancreas/Pre_to_Epsilon_GRN.pdf', figsize=(4, 4))

    # transition driver gene scores
    sp.pl.plot_trans_genes(adata, 'Ductal', 'Ngn3 low EP', savefig='results/pancreas/Ductal_to_lowEP_genes.pdf')
    sp.pl.plot_trans_genes(adata, 'Ngn3 low EP', 'Ngn3 high EP', savefig='results/pancreas/lowEP_to_highEP_genes.pdf')
    sp.pl.plot_trans_genes(adata, 'Ngn3 high EP', 'Pre-endocrine', savefig='results/pancreas/highEP_to_Pre_genes.pdf')
    sp.pl.plot_trans_genes(adata, 'Pre-endocrine', 'Alpha',  savefig='results/pancreas/Pre_to_Alpha_genes.pdf')
    sp.pl.plot_trans_genes(adata, 'Pre-endocrine', 'Delta', savefig='results/pancreas/Pre_to_Delta_genes.pdf')
    sp.pl.plot_trans_genes(adata, 'Pre-endocrine', 'Beta', savefig='results/pancreas/Pre_to_Beta_genes.pdf')
    sp.pl.plot_trans_genes(adata, 'Pre-endocrine', 'Epsilon', savefig='results/pancreas/Pre_to_Epsilon_genes.pdf')

    # scatter plots to compare spliceJAC's instability scores and DEG gene score in the starting cell state
    sp.pl.scatter_scores(adata, 'Ductal', 'Ngn3 low EP', savefig='results/pancreas/Ductal_to_lowEP_scores.pdf')
    sp.pl.scatter_scores(adata, 'Ngn3 low EP', 'Ngn3 high EP', savefig='results/pancreas/lowEP_to_highEP_scores.pdf')
    sp.pl.scatter_scores(adata, 'Ngn3 high EP', 'Pre-endocrine', savefig='results/pancreas/highEP_to_Pre_scores.pdf')
    sp.pl.scatter_scores(adata, 'Pre-endocrine', 'Alpha', savefig='results/pancreas/Pre_to_Alpha_scores.pdf')
    sp.pl.scatter_scores(adata, 'Pre-endocrine', 'Delta', savefig='results/pancreas/Pre_to_Delta_scores.pdf')
    sp.pl.scatter_scores(adata, 'Pre-endocrine', 'Beta', savefig='results/pancreas/Pre_to_Beta_scores.pdf')
    sp.pl.scatter_scores(adata, 'Pre-endocrine', 'Epsilon', savefig='results/pancreas/Pre_to_Epsilon_scores.pdf')
...
def scvelo_scores(adata):
    ...
    sp.pl.compare_scvelo_scores(adata, savefig='results/pancreas/scvelo_scores.pdf')
...
def differentiation_plots(adata):
    ...
    sp.pl.compare_standout_genes(adata, cluster_list=['Alpha', 'Beta', 'Delta', 'Epsilon'],
                                 savefig='results/pancreas/bif_between.pdf')
    sp.pl.tg_bif_sankey(adata, 'Pre-endocrine', ['Alpha', 'Beta', 'Delta', 'Epsilon'],
                        savefig='results/pancreas/sankey.pdf', showfig=False)
    sp.pl.bif_GRN(adata, 'Pre-endocrine', ['Alpha', 'Beta', 'Delta', 'Epsilon'], savefig='results/pancreas/bif_GRN.pdf')
...
def robustness(adata):
    ...
    sp.pl.subsample_stability(adata, savefig='results/pancreas/stability.pdf')

    # test sensitivity to regression method
    sp.tl.regr_method_sens(adata)
    sp.pl.regression_sens(adata, savefig='results/pancreas/inference_method_sens.pdf')

    # test inference robustness to subsampling of cells
    sp.tl.subsampling_sens(adata)
    sp.pl.sampling_sens(adata, savefig='results/pancreas/subsampling_sens.pdf')
